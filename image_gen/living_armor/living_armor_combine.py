...
for color in ["blue","green","red","yellow","black", "white","purple"]:
            ...
            cv2.imwrite("output/living_armor_" + color +".png", base)
            
            print(f""" {{ "link" : ["living_armor_{color}.png" ,"living_armor_{color}_attack.png"], "color":"{color}"}},  """)
