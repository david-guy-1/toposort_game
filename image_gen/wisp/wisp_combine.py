...
for color in ["blue","green","red","yellow","white","purple"]:
            ...
            cv2.imwrite("output/wisp_" + color +".png", base)
            
            print(f""" {{ "link" : ["wisp_{color}.png" ,"wisp_{color}_attack.png"], "color":"{color}"}},  """)
